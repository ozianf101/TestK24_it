package com.example.testk24.ui.login
...
import com.example.testk24.MemberActivity
import com.example.testk24.ProfileActivity

import com.example.testk24.R
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dao = db.getAdminDao()
        if (dao.getData().isEmpty()) {
            dao.insert(Admin(username = "admin", password = "admin123"))
        }
        ...
        loginViewModel.loginResult.observe(this@LoginActivity, Observer {
            ...
            if (loginResult.success != null) {
                if (!DataConst.DataLogin.isEmpty()){
